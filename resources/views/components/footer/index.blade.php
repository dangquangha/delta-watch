<div class="footer" style="background-image: url(' {{ asset('images/banners/banner_footer.jpg') }} '); background-size: cover;">
        ...
        <div class="row">
            ...
            <div class="form col-xl-8 col-lg-8 col-sm-12">
                ...
                <form class="row">
                    ...
                    <button class="btn" type="submit" style="background-color: #05c3ff; transition: none !important;">
...
@include("components.footer.components.copyright")